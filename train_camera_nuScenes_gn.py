...
def train(cfg):
    ...
    project_dir = Path(cfg.output_dir) / f"camera_{cfg.dataset}_gn"
    ...
    if cfg.model_name == "circular_unet":
        model = CircularUNet(
            ...
            use_image_encoder=cfg.use_camera,
            use_pe=cfg.use_pe,
            ...
            if accelerator.is_main_process:
                ...
                if global_step % cfg.save_sample_steps == 0:
                    ...
                    lidar_utils.sample_to_lidar(
                        ...
                        text=c_inputs["texts"],
                        semantic=c_inputs["semantic_org"] if cfg.use_seg and not cfg.use_camera else None,
                        box=c_inputs["box"] if cfg.use_3dbox else None,
                        camera=c_inputs["camera"] if cfg.use_camera else None,
                        camera_info=c_inputs["camera_info"] if cfg.use_camera else None,
...
if __name__ == "__main__":
    '''
        ---- Setting require_grad ----
        total trainable params: 58,841,548
        trainable params: 17,853,248
