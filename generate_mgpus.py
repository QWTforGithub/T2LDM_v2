...
if __name__ == "__main__":
    ...
    # ckpt = "/root/models/checkpoints/nuScenes_SparsetoDense_0000400000.pth"
    # ckpt = "/root/models/checkpoints/nuScenes_3DBox_0000400000.pth"
    # ckpt = "/root/models/checkpoints/nuScenes_BEV_0000400000.pth"
    # ckpt = "/root/models/checkpoints/nuScenes_camera_0000400000.pth"

    # ckpt = "/root/models/checkpoints/nuScenes_text_clip_0000400000.pth"
    ...
    # ckpt = "/root/models/checkpoints/KITTI360_unconditional_0000400000.pth"
    # ckpt = "/root/models/checkpoints/SemanticKITTI_unconditional_0000400000.pth"
    ckpt = "/root/models/checkpoints/nuScenes_unconditional_0000400000.pth"


    seed = 309  # 81, 309, 88, 127, 744,          830, 171,18, 256, 803, 201,
    batch_size = 8  # 32  # 64
