...
def test_emd():
    ...
    pc_path1 = "/data/qwt/models/ControlLidar_aimax/logs/diffusion/nuScenes/spherical-1024/20251107T151721/plys/rank_0_num_step_0_sample_0_batch_0.ply"
    pc_path2 = "/data/qwt/models/ControlLidar_aimax/logs/diffusion/nuScenes/spherical-1024/20251107T151721/plys/baseline_4.ply"
    ...
    pc_path2 = "/data/qwt/models/ControlLidar_aimax/upsampling/1.0_5_95.ply"
    pc_path2 = "/data/qwt/models/ControlLidar_aimax/upsampling/1.0_95_5.ply"

    x1 = common.read_ply(pc_path1)
    x1 = torch.from_numpy(x1).unsqueeze(0).float().cuda()
    x1,_,_ = common.normalize_point_cloud(x1)

    x2 = common.read_ply(pc_path2)
    x2 = torch.from_numpy(x2).unsqueeze(0).float().cuda()
    x2,_,_ = common.normalize_point_cloud(x2)
