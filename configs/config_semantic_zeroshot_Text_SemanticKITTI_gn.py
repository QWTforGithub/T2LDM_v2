...
class TrainingConfig:
    ...
    pkl: str = "semantic_kitti_description.pkl" # "nuscenes_description_plus_plus.pkl"
    ...
    pretrained_checkpoint_dir: str = "/ihoment/youjie10/qwt/model/IJCV/unconditional_SemanticKITTI/diffusion_0000780000.pth"
    # ---- training setting ----
