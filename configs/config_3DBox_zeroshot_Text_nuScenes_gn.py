...
class TrainingConfig:
    ...
    pkl: str = "nuscenes_description_plus_plus.pkl"
    ...
    save_sample_steps: int =  5000#10_000# 5_000 # 10_000 # 1
    save_model_steps: int =  5000#10_000 # 1
    ...
    pretrained_checkpoint_dir: str = "/ihoment/youjie10/qwt/model/IJCV/unconditional_nuScenes/diffusion_0000610000.pth"
    # ---- training setting ----
