...
class TrainingConfig:
    ...
    clip_mode: str = "ViT-L/14"#"ViT-L/14" #"ViT-L/14" # "ViT-B/32", None
    clip_pool_features: bool = False # True -> [B,768/512], False -> [B,77,768/512]
    text_channels: int = 768#1024#768
    T5_mode: str = "large"#"base" # small 512 , large 1024, base 768
    ...
    diffusion_prediction: Literal["eps", "v", "x0"] = "v" #  10W -> x0 75+ 75+ | v 77+ 78+
