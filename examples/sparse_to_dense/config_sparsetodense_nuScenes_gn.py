...
class TrainingConfig:
    ...
    resolution: tuple[int, int] = (32, 1024)  # if you want to condut S2D or S2D, please set the resolution.
    ...
    upsampling: bool = True  # False # True
    ...
    downsampling: bool = False  # False
    down_rate: float = 0.25  # The downsampling resolution = base_up_rate * down_rate
    base_down_rate: float = 0.25  # The param indicates the dataset name as the condition. LIDAR_TOP_DOWNSAMPLING{base_up_rate}
    interpolate_rate: float = -1 # if you want to use the interpolate guidance, please set the interpolate rate.
    # ---- model setting ----
