...
from examples.sparse_to_dense.config_sparsetodense_nuScenes_gn import TrainingConfig

import examples.sparse_to_dense.loading_sparsetodense_nuScenes  as inference_mgpus
...
def main(args, cfg):
    ...
    if(cfg.use_text or cfg.use_camera or cfg.use_control_net):
        ...
        sampling_lidar_path = args.file_path
        ...
        batch = common.get_batch(
            ...
            sampling_depth=sampling_range_image,
...
if __name__ == "__main__":
    ...
    # num_steps = 400_000
    random_num = 256
    project_dir = "examples/sparse_to_dense"
    project_dir = f"{root_path}/{project_dir}/test_sparsetodense_nuScenes"
    load_config = False

    file_path = "../example_files/n008-2018-05-21-11-06-59-0400__LIDAR_TOP__1526915243047392.pcd0.25.bin"
