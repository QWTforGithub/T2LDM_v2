...
from examples.semantic_SemanticKITTI.config_semantic_SemanticKITTI_gn import TrainingConfig

import examples.semantic_SemanticKITTI.loading_semantic_SemanticKITTI  as inference_mgpus
...
def main(args, cfg):
    ...
    if(cfg.use_text or cfg.use_camera or cfg.use_control_net):
        ...
        points = common.get_lidar_sweep(args.reference_file_path, return_intensity=True)

        learning_map = common.get_semantickitti_learning_map(cfg.semantic_class_num)
        with open(args.semantic_file_path, "rb") as a:
        ...
        semantic = range_image[[4]] / cfg.semantic_class_num
...
if __name__ == "__main__":
    ...
    # num_steps = 400_000
    random_num = 256
    project_dir = "examples/semantic_SemanticKITTI"
    project_dir = f"{root_path}/{project_dir}/test_semantic_SemanticKITTI"
    load_config = False

    # 00003 000015 000040 000045
    semantic_file_path = "../example_files/SemanticKITTI_semantic.labell"
    reference_file_path = "../example_files/SemanticKITTI_lidar.bin"
    ...
    parser.add_argument("--semantic_file_path", type=str, default=semantic_file_path)
