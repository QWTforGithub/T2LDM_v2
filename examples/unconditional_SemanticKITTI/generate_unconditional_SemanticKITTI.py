...
from examples.unconditional_SemanticKITTI.config_unconditional_SemanticKITTI_gn import TrainingConfig

import examples.unconditional_SemanticKITTI.loading_unconditional_SemanticKITTI as inference_mgpus
...
if __name__ == "__main__":
    ...
    # num_steps = 400_000
    random_num = 256
    project_dir = "examples/unconditional_SemanticKITTI"
    project_dir = f"{root_path}/{project_dir}/test_unconditional_SemanticKITTI"
    load_config = False
