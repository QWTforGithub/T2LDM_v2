...
from examples.semantic_nuScenes.config_semantic_nuScenes_gn import TrainingConfig

import examples.semantic_nuScenes.loading_semantic_nuScenes  as inference_mgpus
...
def main(args, cfg):
    ...
    if(cfg.use_text or cfg.use_camera or cfg.use_control_net):
        ...
        semantic = np.load(args.semantic_file_path)
...
if __name__ == "__main__":
    ...
    # num_steps = 400_000
    random_num = 256
    project_dir = "examples/semantic_nuScenes"
    project_dir = f"{root_path}/{project_dir}/test_semantic_nuScenes"
    load_config = False

    semantic_file_path = "../example_files/nuScenes_semantic.npy"
