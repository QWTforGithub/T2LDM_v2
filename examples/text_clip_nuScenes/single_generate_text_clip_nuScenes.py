...
import examples.text_clip_nuScenes.loading_text_clip_nuScenes  as inference_mgpus
...
if __name__ == "__main__":
    ...
    # num_steps = 400_000
    random_num = 256
    project_dir = "examples/text_clip_nuScenes"
    project_dir = f"{root_path}/{project_dir}/test_text_clip_nuScenes"
    load_config = False
