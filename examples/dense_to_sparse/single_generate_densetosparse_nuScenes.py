...
from examples.dense_to_sparse.config_densetosparse_nuScenes_gn import TrainingConfig

import examples.dense_to_sparse.loading_densetosparse_nuScenes  as inference_mgpus
...
if __name__ == "__main__":
    ...
    # num_steps = 400_000
    random_num = 256
    project_dir = "examples/dense_to_sparse"
    project_dir = f"{root_path}/{project_dir}/test_densetosparse_nuScenes"
    load_config = False

    file_path = "../example_files/n008-2018-05-21-11-06-59-0400__LIDAR_TOP__1526915243047392.pcd1.0.bin"
