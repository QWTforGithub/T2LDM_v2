...
from examples.unconditional_KITTI360.config_unconditional_KITTI360_gn import TrainingConfig

import examples.unconditional_KITTI360.loading_unconditional_KITTI360 as inference_mgpus
...
if __name__ == "__main__":
    ...
    # num_steps = 400_000
    random_num = 256
    project_dir = "examples/unconditional_KITTI360"
    project_dir = f"{root_path}/{project_dir}/test_unconditional_KITTI360"
    load_config = False
