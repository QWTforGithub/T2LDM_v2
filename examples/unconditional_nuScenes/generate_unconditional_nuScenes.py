...
from examples.unconditional_nuScenes.config_unconditional_nuScenes_gn import TrainingConfig

import examples.unconditional_nuScenes.loading_unconditional_nuScenes as inference_mgpus
...
if __name__ == "__main__":
    ...
    # num_steps = 400_000
    random_num = 256
    project_dir = "examples/unconditional_nuScenes"
    project_dir = f"{root_path}/{project_dir}/test_unconditional_nuScenes"
    load_config = False
